    ...
    def executar ( cls, 
        ...
        for g in range ( nGeracoes ) :
            ...
            def getAvaliacoes ( individuos ) :
                ...
                """
                return [ individuo.getdisponible() for individuo in individuos ]

            # Ordena os filhos por ordem de avaliação
            filhos.sort ( key=lambda ind:ind.getdisponible())
            ...
            if verbose :
                print(f'{bcolors.FAIL}Generacion {bcolors.BOLD}' 
                        ...
                        + str(filhos[0].getdisponible()) + f'{bcolors.ENDC}' )
            ...
            for aval, ind in zip ([ ind.getdisponible() for ind in pop ], pop ) :
                if aval == 0 :
                    if printResult :
                        print('------- Resuelto -----------')
